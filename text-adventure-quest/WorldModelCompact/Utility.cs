...
namespace TextAdventures.Quest
{
    ...
    public class IncludeFileMissingException : Exception
    {
        public string missingInclude;
        public IncludeFileMissingException(string missingInclude, string message) : base(message) 
        {
            this.missingInclude = missingInclude;
        }
    }
    ...
    public static class Utility
    {
        ...
        public static string ConvertVerbSimplePattern(string pattern, string separator)
        {
            ...
            {
                separatorRegex = "(" + string.Join("|", separator.Split(';').Select(s => s.Trim()).ToArray()) + ")";
            }
